...
public class FullScreenVideoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            int status_color= ContextCompat.getColor(FullScreenVideoActivity.this , R.color.full_screen_green_color);
            window.setStatusBarColor(status_color);
        }



        int position= getIntent().getIntExtra("position_in_video_list",0);

        viewPager2_= findViewById(R.id.viewPager_in_fullscreen_video);
        viewPager2_.setAdapter(new full_Screen_Video_Adapter(getApplicationContext()));
